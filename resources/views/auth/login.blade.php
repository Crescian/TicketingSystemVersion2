...
@section('content')
    ...
    <div class="redirect-overlay" id="redirectOverlay">
      ...
      <div class="redirect-bar-wrap"><div class="redirect-bar" id="rdBar"></div></div>
    </div>
    ...
    <div class="login-wrap">
      ...
      <div class="left-panel">
        ...
        <div class="left-main">
          <div class="left-eyebrow"><div class="dot"></div>IT Support Portal</div>
          <h1 class="left-headline">ONE LOGIN.<br>YOUR <em>ROLE.</em><br>YOUR <em>TOOLS.</em></h1>
          <p class="left-desc">Sign in with your company account. We'll automatically take you to the right dashboard based on your role.</p>

          <div class="role-cards">
            <div class="role-card">
              <div class="role-icon customer"><i class="bi bi-person"></i></div>
              <div><div class="role-title">Customer (Employee)</div><div class="role-desc">Submit and track your IT support requests</div></div>
              <i class="bi bi-arrow-right role-arrow"></i>
            </div>
            <div class="role-card">
              <div class="role-icon helpdesk"><i class="bi bi-headset"></i></div>
              <div><div class="role-title">Helpdesk</div><div class="role-desc">Manage the queue, assign technicians</div></div>
              <i class="bi bi-arrow-right role-arrow"></i>
            </div>
            <div class="role-card">
              <div class="role-icon tech"><i class="bi bi-tools"></i></div>
              <div><div class="role-title">IT Technician</div><div class="role-desc">Accept, work on, and resolve tickets</div></div>
              <i class="bi bi-arrow-right role-arrow"></i>
            </div>
            <div class="role-card">
              <div class="role-icon admin"><i class="bi bi-shield-fill"></i></div>
              <div><div class="role-title">IT Admin</div><div class="role-desc">Handle escalations, full system oversight</div></div>
              <i class="bi bi-arrow-right role-arrow"></i>
            </div>
          </div>
        </div>

        <div class="left-footer">© 2025 LGICT Internal Support System. All rights reserved.</div>
      </div>
      ...
      <div class="right-panel">
        <div class="form-box">
          ...
          <p class="form-sub">Use your company email and password. You'll be redirected to your role's dashboard automatically.</p>
          ...
          @if (session('status'))
            <div style="background:#e8f5e9;border:1.5px solid #a5d6a7;border-radius:12px;padding:12px 16px;font-size:13px;font-weight:600;color:var(--gd);display:flex;align-items:center;gap:10px;margin-bottom:18px;">
          ...
          <div class="divider"><div class="divider-line"></div><div class="divider-text">Try a demo role</div><div class="divider-line"></div></div>
          ...
          <p style="text-align:center;font-size:12px;color:var(--tm)">
            ...
            <a href="mailto:support@lgict.com" style="color:var(--gl);font-weight:700">support@lgict.com</a>
          </p>
